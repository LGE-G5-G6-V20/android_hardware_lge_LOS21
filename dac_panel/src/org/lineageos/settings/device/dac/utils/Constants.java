...
public class Constants {
    ...
    public static final String   PROPERTY_HIFI_DAC_DOP = "persist.audio.ess.dop";
    public static final String   PROPERTY_HIFI_DAC_MODE = "persist.audio.ess.dacmode";
    public static final String   PROPERTY_HIFI_DAC_AVC_VOLUME = "persist.audio.ess.avc_volume";
